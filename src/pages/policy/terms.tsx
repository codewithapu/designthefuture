        ...
        <div className={styles.Container}>
          ...
          <div className={styles.SubPart}>
            <p className={styles.Description}>
              ...
              Welcome to our website. If you continue to browse and use this website you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern Edu Burner's relationship with you in relation to this website.
              The term 'Edu Burner' or 'us' or 'we' refers to the owner of the website whose registered/operational office is Suryasen Palli West Lake Road Purulia WEST BENGAL 723101. The term 'you' refers to the user or viewer of our website.
            </p>
          </div>
          ...
          <div className={styles.SubPart}>
            ...
            <div className={styles.Description}>
              <ul className={styles.List}>
                ...
                <li>
                  You may not create a link to this website from another website or document without Edu Burner’s prior written consent.
                </li>
